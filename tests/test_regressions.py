...
Each test reproduces a real-world EPUB processing failure with a minimal
synthesized fixture so the offending file does not need to be checked in.
The tests are expected to fail until the underlying issue is resolved.
"""
